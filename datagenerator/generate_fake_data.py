...
def generate_user_data(user_recs):
    for id in range(user_recs):
...
def generate_clickstream_data(click_recs):
    for _ in range(click_recs):
...
if __name__ == "__main__":
    ...
    generate_user_data(args.user_recs)
    generate_clickstream_data(args.click_recs)